...
拿到新系統當然要先熟悉目錄結構，Ubuntu有六個字符界面的登錄端口，分別是`tty1-6`，使用`Ctrl+ F1 - F6`進行切換，輸入用戶名和密碼就可以登錄。
...
因為字符界面的中文不是很好（很差），所以偶爾還是得切換到圖形界面的Terminal進行操作。
...
<http://linuxg.net/how-to-install-veracrypt-1-0f-1-on-ubuntu-15-04-ubuntu-14-10-ubuntu-14-04-and-derivative-systems/>   
<http://www.guokr.com/blog/749084/>  
<http://www.cnblogs.com/KarryWang/p/4583436.html>
